...
?>
  <body class="animsition">
    ...
    <?php
      if (isset($_SESSION['intranet_permitions'])){
        if (!in_array("Noticias",$_SESSION['intranet_permitions'])){
          ...
          include_once '../../models/anuncios/anuncios.Entity.php';
          include_once '../../models/anuncios/anuncios.Model.php';
          $malo = array("░╠",'<','>','`',"'",'"',"\\");
          $bueno = array("","&lt;","&gt;","&#44;","&#39;","&#34;",'&#92;');
        }else{
          $conexion = false;
          ...
          <div class="page-header-actions" style="z-index: 999">
            <div class="btn-group btn-group-xs">
              <ul class="nav nav-tabs nav-tabs-line" role="tablist" id="tablist">
                <li class="nav-item" role="presentation" data-toggle="tooltip" data-placement="left" data-original-title="Todos los anuncios">
                  <a class="active nav-link" href="#a" aria-controls="exampleList" aria-expanded="true" role="tab" data-toggle="tab" id="Todas las noticias"> <i class="fas fa-globe-americas"></i> </a>
                </li>
            ...
            <?php if ($_SESSION['intranet_perfil'] == 1 || $_SESSION['intranet_perfil'] == 2 || $_SESSION['intranet_perfil'] == 3 || $_SESSION['intranet_usuario'] == 'julio.fuentes'){ ?>
            <div class="btn-group btn-group-sm" aria-label="Button group with nested dropdown" role="group">

               <a class="dropdown-item" role="menuitem" data-toggle="modal" data-target="#modalCreate_Noticia"> <i class="icon  wb-file"></i> Crear anuncio </a>
              <div class="btn-group btn-group-sm" role="group" data-toggle="tooltip" data-placement="left" data-original-title=" Opciones ">
                ...
                <div class="dropdown-menu dropdown-menu-right animate" aria-labelledby="moreOptions" role="menu">
                  ...
                  <div class="dropdown-divider" role="presentation"></div>
                  <a href="javascript:void(0);" class="dropdown-item" onclick="window.location.href='../anuncios/?<?php echo mt_rand(); ?>';"> Actualizar página </a>
                </div>
              </div>
            </div>
            <?php } ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="tab-content">
                    ...
                    <li class="masonry-item">
                      <div class="card card-shadow">
                        <div class="card-header cover overlay overlay-hover">
                          <img class="cover-image overlay-figure overlay-scale" src="../../assets/images/noticias/<?php echo $all->__GET('image'); ?>" alt="...">
                        </div>
                ...
                <div class="tab-pane animation-scale-up" id="tablist_in_<?php echo $push_id; ?>" role="tabpanel">
                  ...
                  <ul class="blocks blocks-100 blocks-xxl-3 blocks-lg-2 blocks-md-2 pt-10">
                  <?php foreach ($stm->readNotice($push_id) as $noticia){ ?>
                    <li class="masonry-item">
                      <div class="card card-shadow">
                        <div class="card-header cover cover overlay overlay-hover">
                          <img class="cover-image overlay-figure overlay-scale" src="../../assets/images/noticias/<?php echo $noticia->__GET('image'); ?>" alt="...">
                        </div>
                        <div class="card-block">
    ...
    <div class="modal fade modal-super-scaled" id="modalCreate_Noticia">
      <div class="modal-dialog modal-lg modal-center">
        <form class="modal-content formCreate" autocomplete="off">
          <div class="modal-header">
            <button class="close" data-dismiss="modal" type="button"> <i class="btn btn-outline btn-dark btn-round icon wb-close"></i> </button>
            <h1 class="modal-title">Nuevo clasificado</h1>
          </div>
          <div class="modal-body">
            ...
            <div class="form-row col-sm-12">
              <div class="col-sm-12">
                ...
                <textarea name="b" id="b" class="form-control" rows="5" placeholder="Contenido de la noticia"></textarea>
              </div>
            </div>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade modal-super-scaled" id="modalEdit_Noticia">
      <div class="modal-dialog modal-lg modal-center">
        <form class="modal-content formEdit" autocomplete="off">
          ...
          <div class="modal-header">
            <button class="close" data-dismiss="modal" type="button"> <i class="btn btn-outline btn-dark btn-round icon wb-close"></i> </button>
            <h1 class="modal-title">Editar Noticia</h1>
          </div>
          <div class="modal-body">
            <div class="form-row col-sm-12">
              <div class="col-sm-6">
    ...
    <?php if ($_SESSION['intranet_perfil'] == 1 || $_SESSION['intranet_perfil'] == 2 || $_SESSION['intranet_perfil'] == 3 || $_SESSION['intranet_usuario'] == 'charly.bello'){ ?>
    <script src="../../controller/anuncios/anuncios.js"></script>
    <?php } ?>
