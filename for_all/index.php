...
?>
  <body class="animsition">
    ...
    <div class="page">
        ...
        <div class="page-aside-inner page-aside-scroll">
          <div data-role="container">
            <div data-role="content">
              <br>
              <?php
                if($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'erika.poveda' || $_SESSION['intranet_usuario'] == 'juan.alvarez' || $_SESSION['intranet_usuario'] == 'andrea.camacho') {
                  ?>
                  <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#crearSeccionFor_all" data-crear_seccion='crear' title="click para crear">
                  ...
                  <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#EliminarSeccionFor_all" data-eliminars='Eliminar' title="click para Eliminar sección">
                ...
                $sql_for_all_secciones = mysqli_query($mysqli, "SELECT `id_seccion`, `seccion` FROM `for_all_secciones` WHERE `estado_seccion` = '0' ORDER BY `id_seccion` DESC ");
                while($rowSecciones =  mysqli_fetch_array($sql_for_all_secciones, MYSQLI_ASSOC)) {
                  ...
                  <section class="page-aside-section">
                    <h5 class="page-aside-title">
                      ...
                      <br>
                      <?php
                      if($_SESSION['intranet_usuario'] == 'raul.enciso'|| $_SESSION['intranet_usuario'] == 'erika.poveda' || $_SESSION['intranet_usuario'] == 'juan.alvarez' || $_SESSION['intranet_usuario'] == 'david.patiño' || $_SESSION['intranet_usuario'] == 'andrea.camacho') {
                        ?>
                        <a class="btn" style="background-color: transparent; border-color: #3e8ef7;" data-toggle="modal" data-target="#CrearPublicacionFor_all" data-publicacion='<?php echo $id_seccion?>' data-usuario_intra='<?php echo $_SESSION['intranet_usuario']?>' data-id_seccion='<?php echo $row['id']; ?>' title="click para nueva publicación">
                    ...
                    <?php
                    $sql_for_all = mysqli_query($mysqli, "SELECT `id`, `titulo`, `tabla`, `name`, `type`, `estado_publicacion` FROM `for_all` WHERE `id_seccion` = '$id_seccion' AND `estado_publicacion` = '0' ORDER BY `for_all`.`id` DESC  ");
                    while($row = mysqli_fetch_array($sql_for_all, MYSQLI_ASSOC)) { 
                      ?>
                      <div class="list-group">
                        ...
                        <?php
                        if($_SESSION['intranet_usuario'] == 'raul.enciso'|| $_SESSION['intranet_usuario'] == 'erika.poveda' || $_SESSION['intranet_usuario'] == 'juan.alvarez'|| $_SESSION['intranet_usuario'] == 'andrea.camacho' || $_SESSION['intranet_usuario'] == 'david.patiño') {
                          ?>
                          <p class="page-header">
                            <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#editarSeccionFor_all" data-id_seccion='<?php echo $row['id']; ?>' title="click para editar">
                              <span class="cambioColor">Editar</span>
                            </a>
                            <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#eliminarSeccionFor_all" data-ideliminarseccion='<?php echo $row['id']; ?>' title="click para eliminar">
      ...
      <div class="page-main">
        <div class="tab-content">
          <?php
          $sql_for_all = mysqli_query($mysqli, "SELECT * FROM `for_all` WHERE `estado_publicacion` = '0' ORDER BY `id` DESC");
          while($row = mysqli_fetch_assoc($sql_for_all)){
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                          <?php
                            if($tipo_imagen == 'video'){
                              ...
                              if($nombre_poster == ''){
                                ?>
                                <video src='./../videos_for_all/<?php echo $nombre_imagen?>' style='width: 100%; height=100%;' controls ></video>
                                <?php
                              }else{
                                ?>
                                <video src='./../videos_for_all/<?php echo $nombre_imagen?>' style='width: 100%; height=100%;' poster="./../imagenes_for_all/<?php echo $nombre_poster?>" controls ></video>
                                <?php
                              }
                              ?>
                              <?php
                              ...
                              ?>
                                <img src='./../imagenes_for_all/<?php echo $nombre_imagen?>' width="100%" height="100%" alt="">
                              <?php 
                            }elseif($tipo_imagen == 'pdf'){
                              ?>
                                <iframe src='./../pdf_for_all/<?php echo $nombre_imagen?>' width=1000 height=500></iframe>
                              <?php
                            }elseif($tipo_imagen == 'xlsx' && $nombre_imagen == "2.6.1 FormatoEvaluacionImpactosCambiosV2.xlsx"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/<?php echo $nombre_imagen?>" download="2.6.1 FormatoEvaluacionImpactosCambiosV2.xlsx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'doc' && $nombre_imagen == "2.6.2 FormatoControlCambiosV3.doc"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/<?php echo $nombre_imagen?>" download="2.6.2 FormatoControlCambiosV3.doc">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'xls' && $nombre_imagen == "2.6.3 FormatoSolicitudCambiosV2.xls"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/<?php echo $nombre_imagen?>" download="2.6.3 FormatoSolicitudCambiosV2.xls">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'xlsx' && $nombre_imagen == "2.6.9 FormatoFichaIndicadoresV5.xlsx"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/<?php echo $nombre_imagen?>" download="2.6.9 FormatoFichaIndicadoresV5.xlsx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'xlsx' && $id == "526"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.10 FormatoCaracterizacionProcesoV3.xlsx" download="2.6.10 FormatoCaracterizacionProcesoV3.xlsx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "527"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.11 FormatoPoliticaV2.docx" download="2.6.11 FormatoPoliticaV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "528"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.12 FormatoProcedimientoV2.docx" download="2.6.12 FormatoProcedimientoV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "529"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.13 FormatoPlanV2.docx" download="2.6.13 FormatoPlanV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "530"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.14 FormatoProgramaV2.docx" download="2.6.14 FormatoProgramaV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "531"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.16 FormatoManualOperativoV2.docx" download="2.6.16 FormatoManualOperativoV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "532"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.15 FormatoInstructivoV2.docx" download="2.6.15 FormatoInstructivoV2.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }elseif($tipo_imagen == 'docx' && $id == "533"){
                              ?>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <a href="./../xlsx_for_all/2.6.18 FormatoMemoriaTrabajoV6.docx" download="2.6.18 FormatoMemoriaTrabajoV6.docx">⚫︎ Descargar</a> <br>
                              </div>
                              <?php
                            }else{
                            }
    ...
    <div class="modal fade" id="CrearPublicacionFor_all" tabindex="-1" role="dialog" aria-labelledby="CrearPublicacionFor_allTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="CrearPublicacionFor_allTitle">CREAR PUBLICACIÓN</h5>
    ...
    <div class="modal fade" id="eliminarSeccionFor_all" tabindex="-1" role="dialog" aria-labelledby="eliminarSeccionFor_allTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarSeccionFor_allTitle">ELIMINAR</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="editarSeccionFor_all" tabindex="-1" role="dialog" aria-labelledby="editarSeccionFor_allTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editarSeccionFor_allTitle">EDITAR</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="crearSeccionFor_all" tabindex="-1" role="dialog" aria-labelledby="crearSeccionFor_allTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="crearSeccionFor_allTitle">CREAR SECCION</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="EliminarSeccionFor_all" tabindex="-1" role="dialog" aria-labelledby="EliminarSeccionFor_allTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="EliminarSeccionFor_allTitle">ELIMINAR SECCION CREADA</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <script>
      $('#verregistros').on('show.bs.modal', function(event) {
        ...
        $.post("./../edicion_for_all/Ver_registros.php", { verregis: verregis }, 
        function(data) {
    ...
    <script>
      $('#EliminarSeccionFor_all').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id_Eliminar = button.data('eliminars')
        $(".id_Eliminar").val(id_Eliminar); +
        $.post("./../edicion_for_all/Eliminar_seccion_creada.php", {
    ...
    <script>
      $('#eliminarSeccionFor_all').on('show.bs.modal', function(event) {
        ...
        $.post("./../edicion_for_all/Eliminar_seccion.php", {
    ...
    <script>
      $('#editarSeccionFor_all').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id_seccion = button.data('id_seccion')
        $(".id_seccion_campo").val(id_seccion); +
        $.post("./../edicion_for_all/Editar_seccion.php", {
    ...
    <script>
      $('#crearSeccionFor_all').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var seccion = button.data('crear_seccion')
        $(".seccion_campo").val(seccion); +
        $.post("./../edicion_for_all/Crear_seccion.php", {seccion: seccion}, 
        function(data) {
          $(".crear").html(data);
        })
      })
    ...
    <script>
      $('#CrearPublicacionFor_all').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var usuario_crea = button.data('usuario_intra')
        var publicacion = button.data('publicacion')
        $(".publicacion_campo").val(publicacion); +
        $.post("./../edicion_for_all/Crear_publicacion.php", {publicacion: publicacion, usuario_crea: usuario_crea}, 
        function(data) {
   ...
   <footer class="site-footer">
    ...
    <script>
      getLink('marcación_telefónica',this);
    ...
    <script type='text/javascript'>
      ...
      $(function(){
          ...
          $("embed").attr("oncontextmenu","return false");
      });
    </script>
    <!-- InstanceEndEditable -->
