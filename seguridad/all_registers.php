...
<table class="table table-striped table-hover" id="all_registers">
	<thead>
		<th>Visitante</th>
		<th>Documento</th>
		<th>Tipo visita</th>
			...
			<div class="modal-body">
				<form class="form" id="formViews">
					...
					<div class="form-row col-xs-12 col-sm-12 col-md-12">
						...
						<div class="form-group col-xs-4 col-sm-4 col-md-4">
							<label for=""> Motivo visita ó centro de costos </label>
					...
					<div class="form-row col-xs-12 col-sm-12 col-md-12">
						<div class="form-group col-xs-6 col-sm-6 col-md-6">
							<label for="casillero_carnet">¿Casillero y carnet?</label>
							<input type="text" id="casillero_carnet" class="form-control" disabled>
						</div>
						<div class="form-group col-xs-6 col-sm-6 col-md-6">
...
<?php
	if (isset($_SESSION['intranet_permitions']) && isset($_SESSION['loggedin_intranet'])){
		...
		echo "<script>window.location.href='../../views/?".password_hash(mt_rand(),PASSWORD_DEFAULT)."'; window.addEventListener('mouseover',function(){ window.location.href='../../views/?".password_hash(mt_rand(),PASSWORD_DEFAULT)."'; });</script> ";
