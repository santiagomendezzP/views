<div class="modal fade" id="exportar_rango" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="./tabla_c_c_rango.php" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <select class="form-control form-control-sm" name="hasta" id="hasta">
                  <option value="01">ENERO</option>
                  <option value="02">FEBRERO</option>
                  <option value="03">MARZO</option>
                  <option value="04">ABRIL</option>
