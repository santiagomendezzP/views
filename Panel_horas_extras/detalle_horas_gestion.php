...
{position: absolute; top: 0; left: 0; width: 100%; z-index: -1}
    ...
    <script>
      ...
      $("#site_adm_pazysalvo_gt").addClass("active");
    </script>
    <div class="page">
     <div class="container">
  ...
  <!-- Edit Modal HTML -->
  <?php 
    require("html/modal_apro_gestion.php");
    require("html/modal_apro_con_gest.php");
  require("ajax/listar_detalle_gestion.php");?>
	
  <script src="js/repor_horas_gest.js"></script>
