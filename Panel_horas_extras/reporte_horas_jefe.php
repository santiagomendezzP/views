...
{position: absolute; top: 0; left: 0; width: 100%; z-index: -1}
    ...
    <script>
      ...
      $("#site_reporte_horas_jefe").addClass("active");
    </script>
    <div class="page">
     <div class="container" style="background-color: white;">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2>Reporte horas extras</b></h2>
            <p>
              <h3>Filtrar por fechas</h3>
              <label style="color: black;">Fecha de:</label>
              <input type="date" value="<?php echo date("Y-m-01");?>" id="fecha_ini" >
            </p>
            <?php $fecha_actual = date("Y-m-d");?>
            <p>
              <label style="color: black;">Fecha hasta:</label>
              <input type="date" value="<?php echo date("Y-m-01",strtotime($fecha_actual."+ 1 month"));?>" id="fecha_fin">
            </p>

          </div>
          <div class="col-sm-6">
         <!--    <a href="#addgeneralModal" class="btn btn-success" data-toggle="modal"><i class="far fa-file">&#xE147;</i> <span>Agregar nuevo </span></a> -->
          </div>
                </div>
            </div>
        ...
        <div id="custom-search-input">
          <div class="input-group col-md-12">
              ...
              <span class="input-group-btn">
                <!--<button class="btn btn-warning" type="button" onclick="load(1);">
...
<div class="row">
    <div class="collapse" id="collapseExample">
        <div class="card card-body" style="height: 350px; width: 320px;">
...
<div class="row">
    <div class="collapse" id="collapseExample">
      ...
      require("html/modal_apro_jefe.php");
      require("html/modal_apro_conso_jefe.php");
      ?>
  ...
  <!-- Edit Modal HTML -->
<?php
  if(isset($_SESSION['horas_actuales_jefe'])){?>
<script >
  var url="./ajax/listar_detalle_jefe.php"
  var id = <?php echo $_SESSION['horas_actuales_jefe'];?>;
  $.ajax({   
    type: "POST",
    url:url,
    data:{ id: id},
...
<?php }else{ ?>
  <script src="js/repor_horas_jefe.js"></script>
  ...
  <script >
    function load(fecha_ini,fecha_fin){
    
    var parametros = {"fecha_ini":fecha_ini,"fecha_fin":fecha_fin};
    $("#loader").fadeIn('slow');
    $.ajax({
        method:"POST",
        url:'ajax/listar_horas_jefe.php',
        data: parametros,
