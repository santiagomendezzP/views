...
?>
  ...
  <script>
      $("#site_reporte_horas_user").addClass("active");
    </script>
  <div class="page">
    <div class="container" style="background-color: white;">
      <div class="table-wrapper">
        ...
        <?php
          include ("html/modal_modificar_user.php");
          include ("html/modal_modificar_con_user.php");
        ?>
      </div>
    </div>
    <script src="js/repor.js"></script>
    ...
    <!-- <script src="js/calcular_diferencia_horas_modifica.js"></script> -->
