...
function selector(){
  ...
  // HU-004: llamar clasificación solo cuando son horas extras
...
// HU-004: Clasificación automática de concepto de horas extra
...
var esNocturno = function(t) {
  ...
  if (esMixto) {
    Swal.fire({
      ...
      text: 'Se identificó que el rango registrado contiene horas extra diurnas y nocturnas. Para garantizar una correcta clasificación y liquidación, registre las horas diurnas y nocturnas en solicitudes independientes.',
  ...
  var ocultar = [];
  if (esDiurno(ini) && esDiurno(end)) {
    ocultar = ['100', '201'];
  } else if (esNocturno(ini) && esNocturno(end)) {
    ocultar = ['9', '205'];
  }
