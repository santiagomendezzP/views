...
?>
  <body class="animsition">
    ...
    <script>
      $("#site_exportar_horas").addClass("active");
    </script>
    <div class="page">
      <div class="container">
        <div class="table-wrapper">
          ...
          include ("html/modal_exportar.php");
          include ("html/modal_exportar_rango.php");
          $cons = mysqli_query($con,"SELECT * FROM c_costos");
          echo "<div class='row'>";
          echo "<div class='col-md-4'>";
              echo "<button type='button' class='btn btn-success' data-toggle='modal' data-target='#exportar_rango' style='margin-top: 10px;'>Exportar horas general</button>";
            echo "</div>";
          while($row = mysqli_fetch_array($cons)){
              if($row['id_proyecto'] != 5 && $row['id_proyecto'] != 15 && $row['id_proyecto'] != 32 && $row['id_proyecto'] != 4 && $row['id_proyecto'] != 7 && $row['id_proyecto'] != 27 && $row['id_proyecto'] != 49 ){

                echo "<div class='col-md-4'>";
                  echo "<button type='button' class='btn btn-info' data-toggle='modal' data-target='#exportar' data-id=".$row['id_proyecto']." style='margin-top: 10px;'>".$row['proyecto']."</button>";
                echo "</div>";
