	...
	<div class="container">
        <div class="row">
                ...
                if($estado_gere == 2){
                  ...
                  data-toggle="modal" 
                  data-target="#aprobar_con_gere" 
                  data-id_r='<?php echo $id_r; ?>'
                  data-correo_solicitante_gere_data='<?php echo $correo_solicitante; ?>'
                  data-nombre_solicitante_gere_data='<?php echo $nombre_solicitante; ?>'>APROBAR</button>
                  <?php
                }else{
      ...
      <script src="./js/detalle_horas_gere.js"></script>
      <script>
