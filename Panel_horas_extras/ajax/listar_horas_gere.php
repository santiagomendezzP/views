...
if ($_SESSION['intranet_usuario'] == 'maribel.bautista') {
    if($action == 'ajax'){
        $campos = "*";
        $tables = "reporte_horas";
        $id = $_SESSION['intranet_id'];
        $query = mysqli_query($con,"SELECT $campos FROM  $tables WHERE `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 32 ");
        ?>
        <!doctype html>
        <html lang="en">
            <head>
                ...
                <script>
                    $( "#atras" ).click(function() {
                        ...
                        function load(page){
                            ...
                            $("#loader").fadeIn('slow');
                            $.ajax({
                                url:'ajax/listar_horas_gere.php',
                                data: parametros,
...
}else if ($_SESSION['intranet_usuario'] == 'sandra.duran') {
    if($action == 'ajax'){
        $campos = "*";
        $tables = "reporte_horas";
        $id = $_SESSION['intranet_id'];
        $query = mysqli_query($con,"SELECT $campos FROM  $tables WHERE `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 31 OR `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 27 OR `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 6 OR `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 4 ");
        ?>
        <!doctype html>
        <html lang="en">
            <head>
...
}else if ($_SESSION['intranet_usuario'] == 'john.cortes' || $_SESSION['intranet_usuario'] == 'sandra.leuro') {
    if($action == 'ajax'){
        $campos = "*";
        $tables = "reporte_horas";
        $id = $_SESSION['intranet_id'];
        $query = mysqli_query($con,"SELECT $campos FROM  $tables WHERE `estado_jefe` = 3 && `estado_n` = 3 && `proyecto` = 26 ");
        ?>
        <!doctype html>
        <html lang="en">
            <head>
