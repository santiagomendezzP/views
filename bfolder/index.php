...
<body class="animsition">
  ...
  <script>
    ...
    $("#site_talento_humano").addClass("active");
  ...
  <div class="page">
      ...
      <div class="page-aside-inner page-aside-scroll">
        <div data-role="container">
          <div data-role="content">
            <br>
            <?php
            if ($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'maria.dominguez' || $_SESSION['intranet_usuario'] == 'leidy.forero' || $_SESSION['intranet_usuario'] == 'andrea.camacho') {
            ?>
              <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#crearSeccionSgvidas" data-crear_seccion='crear' title="click para crear">
              ...
              <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#EliminarSeccionSgvidas" data-eliminars='Eliminar' title="click para Eliminar sección">
            ...
            $sql_sgvidas_secciones = mysqli_query($mysqli, "SELECT `id_seccion`, `seccion` FROM `sgvidas_secciones` WHERE `estado_seccion` = '0' ORDER BY `id_seccion` DESC ");
            while ($rowSecciones =  mysqli_fetch_array($sql_sgvidas_secciones, MYSQLI_ASSOC)) {
            ...
            ?>
              <section class="page-aside-section">
                <h5 class="page-aside-title">
                  ...
                  if ($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'maria.dominguez' || $_SESSION['intranet_usuario'] == 'leidy.forero' || $_SESSION['intranet_usuario'] == 'andrea.camacho') {
                  ?>
                    <a class="btn" style="background-color: transparent; border-color: #3e8ef7;" data-toggle="modal" data-target="#CrearPublicacionSgvidas" data-publicacion='<?php echo $id_seccion ?>' data-usuario_intra='<?php echo $_SESSION['intranet_usuario'] ?>' data-id_seccion='<?php echo $row['id']; ?>' title="click para nueva publicación">
                ...
                <?php
                $sql_sgvidas = mysqli_query($mysqli, "SELECT `id`, `titulo`, `tabla`, `name`, `type`, `estado_publicacion` FROM `sgvidas` WHERE `id_seccion` = '$id_seccion' AND `estado_publicacion` = '0' ORDER BY `sgvidas`.`id` DESC  ");
                while ($row = mysqli_fetch_array($sql_sgvidas, MYSQLI_ASSOC)) {
                ?>
                  <div class="list-group">
                    ...
                    <?php
                    if ($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'maria.dominguez' || $_SESSION['intranet_usuario'] == 'leidy.forero' || $_SESSION['intranet_usuario'] == 'david.patiño'  || $_SESSION['intranet_usuario'] == 'andrea.camacho') {
                    ?>
                      <p class="page-header">
                        <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#editarSeccionSgvidas" data-id_seccion='<?php echo $row['id']; ?>' title="click para editar">
                          <span class="cambioColor">Editar</span>
                        </a>
                        <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#eliminarSeccionSgvidas" data-ideliminarseccion='<?php echo $row['id']; ?>' title="click para eliminar">
    ...
    <div class="page-main">
      <div class="tab-content">
        <?php
        $sql_sgvidas = mysqli_query($mysqli, "SELECT * FROM `sgvidas` WHERE `estado_publicacion` = '0'  ORDER BY `id` DESC");
        while ($row = mysqli_fetch_assoc($sql_sgvidas)) {
          ...
          <div class="tab-pane active animation-scale-up" id="<?php echo $row['tabla'] ?>" role="tabpanel">
            <div class="row">
              <div class="page-header">
                <h1 class="page-title">
                  <center><?php echo $titulo_publicacion ?></center>
                </h1>
                    ...
                    <div class="panel-body">
                      <div class="col-xs-12 col-md-12 col-lg-12">
                        ...
                        ?>
                          ...
                          if ($nombre_poster == '') {
                          ?>
                            <video src='./../videos_sgvidas/<?php echo $nombre_imagen ?>' style='width: 100%; height=100%;' controls></video>
                          <?php
                          } else {
                          ?>
                            <video src='./../videos_sgvidas/<?php echo $nombre_imagen ?>' style='width: 100%; height=100%;' poster="./../imagenes_sgvidas/<?php echo $nombre_poster ?>" controls></video>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          if ($id_imagen == 3100115) {
                          ?>
                            <div id="div_">
                              
                              <div>
                                <img src='./../imagenes_sgvidas/1j.jpg' width="100%" height="100%">
                              </div>
                              <br>
                              <div>
                                <img src='./../imagenes_sgvidas/2j.png' width="100%" height="100%">
                              </div>
                              <br>
                              <div>
                                <img src='./../imagenes_sgvidas/3j.png' width="100%" height="100%">
                              </div>
                              <br>
                              <div>
                                <img src='./../imagenes_sgvidas/4j.png' width="100%" height="100%">
                              </div>
                              <br>
                              <div>
                                <img src='./../imagenes_sgvidas/<?php echo $nombre_imagen ?>' width="100%" height="100%">
                              </div>
                            </div>
                          <?php
                          } elseif ($tipo_imagen == 'imagen' && $id_imagen == 3100153) {
                            ?>
                              <a href="https://indd.adobe.com/view/f2efa1b2-aa89-4e85-a7b0-260d14c19053" target="_blank">
                                <img src='./../imagenes_sgvidas/<?php echo $nombre_imagen ?>' width="100%" height="100%">
                              </a>
                            <?php
                          } elseif($tipo_imagen == 'imagen' && $id_imagen == 31001) {
                            ?>
                              <a href="https://www.flipsnack.com/86E9C9FF8D6/plan-de-beneficios-y-otros-compromisos-por-colombia-v7/full-view.html" target="_blank">
                                <img src='./../imagenes_sgvidas/<?php echo $nombre_imagen ?>' width="100%" height="100%">
                              </a>
                            <?php
                          }else {
                            ?>
                              <img src='./../imagenes_sgvidas/<?php echo $nombre_imagen ?>' width="100%" height="100%" alt="">
                            <?php
                          }
                        } elseif ($tipo_imagen == 'pdf') {
                          ?>
                          <iframe src='./../pdf_sgvidas/<?php echo $nombre_imagen ?>' width=1000 height=500></iframe>
                        <?php
                        } elseif ($tipo_imagen == 'link') {
                          ?>
                            <a href='<?php echo $nombre_imagen ?>' target="_blank">
                              <img src='./../imagenes_sgvidas/<?php echo $nombre_poster ?>' width="100%" height="100%">
                            </a>
                          <?php
                        } else {
                        }
  ...
  <!--CREAR PUBLICACIÓN SGVIDAS-->
  <div class="modal fade" id="CrearPublicacionSgvidas" tabindex="-1" role="dialog" aria-labelledby="CrearPublicacionSgvidasTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="CrearPublicacionSgvidasTitle">CREAR PUBLICACIÓN</h5>
  ...
  <!--ELIMINAR SECCION SGVIDAS-->
  <div class="modal fade" id="eliminarSeccionSgvidas" tabindex="-1" role="dialog" aria-labelledby="eliminarSeccionSgvidasTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="eliminarSeccionSgvidasTitle">ELIMINAR</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <!--EDITAR SECCION SGVIDAS-->
  <div class="modal fade" id="editarSeccionSgvidas" tabindex="-1" role="dialog" aria-labelledby="editarSeccionSgvidasTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editarSeccionSgvidasTitle">EDITAR</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <!--CREAR SECCION SGVIDAS-->
  <div class="modal fade" id="crearSeccionSgvidas" tabindex="-1" role="dialog" aria-labelledby="crearSeccionSgvidasTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="crearSeccionSgvidasTitle">CREAR SECCION</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <!-- ELIMINAR SECCION CREADA SGVIDAS-->
  <div class="modal fade" id="EliminarSeccionSgvidas" tabindex="-1" role="dialog" aria-labelledby="EliminarSeccionSgvidasTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="EliminarSeccionSgvidasTitle">ELIMINAR SECCION CREADA</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <script>
    $('#verregistros').on('show.bs.modal', function(event) {
      ...
      $.post("./../edicion_sgvidas/Ver_registros.php", {
          verregis: verregis
        },
        function(data) {
  ...
  <script>
    $('#EliminarSeccionSgvidas').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget) // Button that triggered the modal
      var id_Eliminar = button.data('eliminars')
      $(".id_Eliminar").val(id_Eliminar); +
      $.post("./../edicion_sgvidas/Eliminar_seccion_creada.php", {
  ...
  <script>
    $('#eliminarSeccionSgvidas').on('show.bs.modal', function(event) {
      ...
      $.post("./../edicion_sgvidas/Eliminar_seccion.php", {
  ...
  <script>
    $('#editarSeccionSgvidas').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget) // Button that triggered the modal
      var id_seccion = button.data('id_seccion')
      $(".id_seccion_campo").val(id_seccion); +
      $.post("./../edicion_sgvidas/Editar_seccion.php", {
  ...
  <script>
    $('#crearSeccionSgvidas').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget) // Button that triggered the modal
      var seccion = button.data('crear_seccion')
      $(".seccion_campo").val(seccion); +
      $.post("./../edicion_sgvidas/Crear_seccion.php", {
          seccion: seccion
        },
        function(data) {
          $(".crear").html(data);
