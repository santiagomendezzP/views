...
<head>
  <meta charset="UTF-8">
  <title>Encuesta diaria codid 19</title>
  <link rel="stylesheet" href="css/estilo.css">
</head>
<body>

  <div class="contenedor">
    <h2>REGISTRO DE SEGUIMIENTO A SÍNTOMAS DE SALUD RELACIONADOS CON COVID 19</h2>

    <h2>Estamos interesados en su bienestar, por ello, hemos adoptado todas las medidas posibles para evitar el riesgo de contagio del Covid-19. Lo invitamos a contestar diariamente la siguiente pregunta:</h2>

    <form action="inserta_diario.php" method="post">
  ...
  $("#conoce_no").removeAttr('readonly');
   ...
   $("#conoce_no").attr('readonly','readonly');
       ...
       <div class="form-group">
         <!--   <p> Registre su temperatura al iniciar su jornada de trabajo *</p> -->

   
          <input type="text"    name="jornada"  value="Realizo la encuesta" hidden= "true" class="form-control">
         <br>
        <!--    <input type="number"   step="0.001" name="temperatura_ini"  value="SI CONOCE" class="form-control"> -->
...
<!--      </div> -->
  ...
  <font size ="3", color ="black"> <p>Ha presentado cambios en las condiciones de su estado de salud reportadas en el cuestionario de inicio de cada semana.</font>
  ...
  <td>
       <div class="form-group">
         ...
         SI <input type="radio" name="salud_cambio" value="La condicion de salud cambio" id="mostrar"  required>
            
          NO  <input type="radio" name="salud_cambio" value="sigue siendo la misma" id="ocultar"  required> 
          </div> 
    </td>
...
<div id="tabla">
      ...
      <p><font size ="3", color ="black">Si su repuesta es que la condición de salud cambio, especifique los mencionados cambios</font></p>
</div>
...
<table class="24" >
  ...
  <tr>
    ...
    <td>         <p> <font size ="3", color ="black">Tos seca y persistente</p></font></td>
  ...
  <tr>
    ...
    <td>  <p><font size ="3", color ="black">  Fiebre de más de 37.5°C ?</p></font></td>
    ...
    <td style="background-color:white" >
      <div class="form-group">
             ...
             NO <input type="radio" name="fiebre" value="NO" required checked> 
   ...
   <tr>
    ...
    <td> <p><font size ="3", color ="black"> Dificultad para respirar de inicio reciente</font></p></td>
...
<tr>
    ...
    <td> <p><font size ="3", color ="black"> Fatiga</font></p></td>
  ...
  <tr>
    ...
    <td > <p><font size ="3", color ="black"> Dolor de garganta</font></p></td>
 ...
 <div class="form-group">
  ...
  <tr>
    ...
    <td> <p><font size ="3", color ="black"> Malestar general o escalofríos que limiten las actividades de la vida diaria</font></p></td>
  ...
  <tr>
    ...
    <td > <p><font size ="3", color ="black">Secreción nasal o congestión, no relacionada con procesos alérgico</font></p></td>
...
<tr>
    ...
    <td > <p><font size ="3", color ="black"> Pérdida del olfato y/o gusto  </font></p></td>
 ...
 <table class="grupo" style="border: hidden">
  <tr>
    <td style="border: hidden">
   <p><font size ="3", color ="black"> ¿Hay alguien en su vivienda, o con quien usted haya tenido contacto, que se le haya ordenado cuarentena preventiva o se le haya diagnosticado infección por Covid 19?</font></p>
    </td>
  ...
  <td>
       <div class="form-group">
             ...
             NO <input type="radio" name="grupo_r" value="NO" required checked> 
          </div> 
    </td>
...
<br>
  ...
  <div class="form-group">
<font size ="3", color ="black">En caso de que su respuesta sea afirmativa, amplié (parentesco y motivo del ordenamiento de la cuarentena preventiva)</font>
<!-- 
       <textarea  name="grupo_r_no" placeholder="Escriba aqui.."  class="form-control" ></textarea> -->
               <input type="text" name="grupo_r_no" id="grupo_r_no"   value="NO"  class="form-control">
...
<p><font size ="3", color ="black"> En caso de presentar temperatura superior a 37.5°C o alguna otra condición que pueda afectar su estado de salud por un posible contagio de COVID-19, por favor comuníquese de manera inmediata con su EPS o a la línea 123, reporte en la aplicación CoronAPP e informe a su jefe inmediato o al responsable de S.S.T</font></p>
<!----------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------->
...
<table class="grupo" style="border: hidden">
  <tr>
    <td style="border: hidden">
  <font size ="4", color="black"><b>¿Se encuentra en las instalaciones de la empresa?</b></font>
...
<!--     <tr>
          ...
          <td style="border: hidden">
        <font size ="3", color ="black"> <p> ¿Guantes de nitrilo?</p></font>
          </td>
...
<table id="tabla3">
  ...
  <!--   <tr>
      ...
      <div class="btn__group">
               <input type="submit" name="guardar" value="Enviar" class="btn btn__primary">
        <a href="test_covid_diario.php" class="btn btn__danger">Cancelar</a>
