...
?>
	<div class="modal fade" id="mostrarmodal" tabindex="-1" role="dialog"  aria-labelledby="basicModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	  ...
	  <a href="modelo/insert.php?c=$c" class="btn btn-primary fas fa-sign-out-alt"> ! SALIR !</a>
	  <h3><CENTER>  <a href="modelo/insert_bteam.php?c=$c"> Haz clic aquí para más información <BR> "El mejor equipo"</a></H3>
   ...
   <div id="content">  
       <div id="left">
      <!--   <div id="object1"><H3> Trabajo en casa <br></H3><img src="trabajo_casa.PNG" width="330"></H3>-->
        <!-- <div id="object1"><H3> Felíz día del niño <br></H3>-->
      <!-- <img src="../../imagenes_videos/imagenes/ELMEJOREQUIPO/dia_madre.jpg" width="330"></H3>-->
      <!--<h3>Medidas preventivas frente a la emergecia sanitaria</h3>-->
      <img src="../../imagenes_videos/imagenes/ELMEJOREQUIPO/medidas_prevencion.png" width="330"></H3>
      <BR>
      <BR>
        </div> 
         ...
            
          ...
          <div id="right">  
      <!--  <div id="object1"><h3>Información del coronavirus</h3> -->
      <img src="coronav.PNG" width="330">   
     
      </div>
	  
      <a href="modelo/insert_encuesta_semanal.php?c=$c" class="btn btn-danger fas fa-sign-out-alt"> ENCUESTA SEMANAL COVID-19</a>
   
       <BR>
          <BR>
          <a href="modelo/insert_encuesta_diaria.php?c=$c" class="btn btn-primary fas fa-sign-out-alt"> ENCUESTA DE SEGUIMIENTO DIARIO COVID-19</a> 
        <BR>
          <BR>
   <!-- 
     <a href="modelo/insert_encuesta_diaria_f.php?c=$c" class="btn btn-success fas fa-sign-out-alt"> TEST CODIV 19 FINALIZAR JORNADA</a>    
-->
      <!--<h3>Medidas preventivas frente a la emergecia sanitaria</h3>-->
   </div>
