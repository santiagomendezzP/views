                ...
                <ul class="site-menu-sub">
                  ...
                  <li class="site-menu-item" id="site_innovacion">
                    <a class="animsition-link" href="../innovacion/?<?php echo mt_rand(); ?>">
                      <span class="site-menu-title" style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">Innovar para crecer </span>
                    </a>
                  </li>
...
<img id="fondo" src="../../imagenes_videos/imagenes/INICIO/COVID-SEMANAL.png" alt="background image" />
 ...
 <?php 
  ...
  if(isset($_POST['guardar'])){
    $conoce=$_POST['conoce'];
    $conoce_no=$_POST['conoce_no'];
    $alguien=$_POST['alguien'];
    $alguien_no=$_POST['alguien_no'];
    $tos=$_POST['tos'];
    $fiebre=$_POST['fiebre'];
    ...
    if ($grupo_r == 'NO') {
      ...
      $tension_alta= 'NO';
      $embarazo= 'NO';
      $enfermedad_pulmonar= 'NO';
      $afecciones_cardiacas= 'NO';
      $sistema_inmunitario= 'NO';
      ...
      $mayor_60=$_POST['mayor_60'];
      $tension_alta=$_POST['tension_alta'];
      $embarazo=$_POST['embarazo'];
      $enfermedad_pulmonar=$_POST['enfermedad_pulmonar'];
      $afecciones_cardiacas=$_POST['afecciones_cardiacas'];
      $sistema_inmunitario=$_POST['sistema_inmunitario'];
    ...
    // $grupo_r_no=$_POST['grupo_r_no'];
    //$contacto=$_POST['contacto'];

    $tapa_bocas=$_POST['tapa_b'];
    $aplicaron_vacuna=$_POST['aplicaron_vacuna'];

    $dispuesto_aplicarse = '';
    if ($aplicaron_vacuna == 'SI') {
      $dispuesto_aplicarse = 'No aplica';
    }else if ($aplicaron_vacuna == 'NO') {
      $dispuesto_aplicarse = $_POST['dispuesto_aplicarse'];
    }

    $dosis_resibidas=$_POST['dosis_resibidas'];
  
    if ($_POST['explique_porque'] == '' || $_POST['explique_porque'] == NULL) {
      $explique_porque = 'No aplica';
    }else{
      $explique_porque=$_POST['explique_porque'];
    }


    $intranet_usuario=$_SESSION['intranet_usuario'];
    $intranet_id=$_SESSION['intranet_id'];
    ...
    $nombre_vacuna_1 = $_POST['nombre_vacuna_1'];
    $nombre_vacuna_2 = $_POST['nombre_vacuna_2'];
    $nombre_vacuna_3 = $_POST['nombre_vacuna_3'];
    $nombre_vacuna_4 = $_POST['nombre_vacuna_4'];

     if(!empty(!empty($conoce) && $conoce_no) && !empty($alguien) && !empty($alguien_no)   && !empty($tos) && !empty($fiebre) && !empty($d_respirar) && !empty($fatiga) && !empty($malestar) && !empty($secreciones) && !empty($dolor_g) && !empty($grupo_r)  && !empty($intranet_usuario) &&  !empty($intranet_id) &&  !empty($intranet_cargo) &&  !empty($intranet_proyecto) && !empty($estado)){

        $consulta_insert=$con->prepare('INSERT INTO escuesta_semanal(id_usuario,id_cargo,id_proyecto,usuario,id_perfil,conoce,conoce_no,alguien,alguien_no,tos,fiebre,d_respirar,fatiga,malestar,secreciones,dolor_g,olfato,grupo_r,mayor_60,tension_alta,embarazo,enfermedad_pulmonar,afecciones_cardiacas,sistema_inmunitario,cancer,tabaquismo, obesidad, diabetis,enfermedad_renal, otro,cual,estado,tapa_bocas,aplicaron_vacuna,dosis_resibidas,dispuesto_aplicarse,explique_porque,fecha,primera_dosis,segunda_dosis,primer_refuerzo,segundo_refuerzo) VALUES(:intranet_id,:intranet_cargo,:intranet_proyecto,:intranet_usuario,:intranet_perfil,:conoce,:conoce_no,:alguien,:alguien_no,:tos,:fiebre,:d_respirar,:fatiga,:malestar,:secreciones,:dolor_g,:olfato,:grupo_r,:mayor_60,:tension_alta,:embarazo,:enfermedad_pulmonar,:afecciones_cardiacas,:sistema_inmunitario,:cancer,:tabaquismo,:obesidad,:diabetis,:enfermedad_renal,:otro,:cual,:estado,:tapa_bocas,:aplicaron_vacuna,:dosis_resibidas,:dispuesto_aplicarse,:explique_porque,NOW(),:nombre_vacuna_1,:nombre_vacuna_2,:nombre_vacuna_3,:nombre_vacuna_4)');
        ...
        $consulta_insert->execute(array(
          ...
          ':afecciones_cardiacas' =>$afecciones_cardiacas,
          ':sistema_inmunitario' =>$sistema_inmunitario,
          ...
          ':estado' =>$estado,
          ':tapa_bocas' =>$tapa_bocas,
         
          ':aplicaron_vacuna' =>$aplicaron_vacuna,
          ':dosis_resibidas' =>$dosis_resibidas,
          ':dispuesto_aplicarse' =>$dispuesto_aplicarse,
          ':explique_porque' =>$explique_porque,

          ':nombre_vacuna_1' =>$nombre_vacuna_1,
          ':nombre_vacuna_2' =>$nombre_vacuna_2,
          ':nombre_vacuna_3' =>$nombre_vacuna_3,
          ':nombre_vacuna_4' =>$nombre_vacuna_4,
...
<script>
     swal("Gracias", "Gracias por diligenciar la encuesta semanal :)", "success");
    </script>
