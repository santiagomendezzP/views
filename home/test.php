...
if ($resultado = $mysqli->query($sql)) {
  ...
  // echo $_SESSION['intranet_name'];
  // $a=$_SESSION['loggedin_intranet'];

  // echo $_SESSION['intranet_name'];
  $c=$_SESSION['intranet_name'];

 //echo $_SESSION['intranet_perfil'];


 //echo $_SESSION['intranet_perfil'];
  // $c=$_SESSION['intranet_perfil'];
...
?>
	<div class="modal fade" id="mostrarmodal" tabindex="-1" role="dialog"  aria-labelledby="basicModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	  ...
	  <a href="modelo/insert.php?c=$c,medidas=$medidas" class="btn btn-primary fas fa-sign-out-alt"> ! SALIR !</a>
	  <h3><CENTER>  <a href="modelo/insert_bteam.php?c=$c">TEST COVID 19 </a></H3>


		   
      <div class="modal-header">
	  <h3>  Cuestionario informativo para seguimiento a la salud de los trabajadores en el marco de la contingencia por el Covid 19
      <BR>
      <BR>
    Estamos interesados en su bienestar y por ello hemos adoptado todas las medidas posibles para evitar la expansión de la epidemia.  Lo invitamos a que responda con toda veracidad y objetividad este breve cuestionario:
<BR>
    <BR> OBLIGATORIO
  </H3>
...
<form name="add_general" id="add_general">
          <div class="modal-header">            
          ...
          <div class="modal-body">          
            ...
            <div class="form-group">
              <label>¿Conoce usted las medidas dispuestas por la Empresa para atender la emergencia del Covid 19? </label>
              <input type="text" name="medidas" id="medidas" class="form-control" required>
            </div>
            <div class="form-group">
              <label>¿Hay alguien en su vivienda, o con quien usted haya tenido contacto, que se le haya ordenado cuarentena preventiva o se le haya diagnosticado infección por (COVID-19)?</label>
              <input type="text" name="apellidos" id="apellidos" class="form-control" required>
            </div>
            <div class="form-group">
              <label>En las últimas 24 hrs, ha presentado síntomas asociados a la infección por (COVID-19) tales como: *</label>
          ...
          <div class="modal-footer">
            ...
            <h3><CENTER>  <a href="insert.php?c=$c">TEST COVID 19 </a></H3>
          </div>
        </form>
	  ...
	  <a href="" class="btn btn-primary fas fa-sign-out-alt"> INNOVACIÓN Y DESARROLLO</a>
      </div>
      ...
      <div class="page-content p-0">
        <ul class="blocks no-space blocks-100 blocks-xlg-3 blocks-md-2">
          ...
          <li class="card card-inverse overlay overlay-hover">
            ...
            <div class="card-img-overlay overlay-background overlay-background-fixed text-center vertical-align">
              <div class="vertical-align-middle">
                <h3 class="card-title mb-20 ppn-1" onclick="window.location.href='../innovacion/?<?php echo mt_rand(); ?>';" >Innovamos para crecer </h3>
                <div class="card-text card-divider">
                  <span></span>
                </div>
              </div>
