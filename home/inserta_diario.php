...
// }
    ...
    if(!empty($tos) && !empty($fiebre) &&  !empty($d_respirar) && !empty($fatiga) && !empty($malestar) && !empty($secreciones) && !empty($dolor_g) && !empty($olfato)  && !empty($salud_cambio)  && !empty($grupo_r)  && !empty($grupo_r_no)  &&  !empty($intranet_documento) && !empty($intranet_name) && !empty($intranet_usuario) &&  !empty($intranet_id)  &&  !empty($intranet_cargo)  &&  !empty($intranet_proyecto) &&  !empty($jornada) && !empty($estado)){

        $consulta_insert=$con->prepare('INSERT INTO test_diario(tos,fiebre,d_respirar,fatiga,malestar,secreciones,dolor_g,olfato,salud_cambio,grupo_r,grupo_r_no,  cedula,nombre,usuario,id_usuario,cargo,proyecto,fecha,estado,tapa_bocas,jornada) VALUES(:tos,:fiebre,:d_respirar,:fatiga,:malestar,:secreciones,:dolor_g,:olfato,:salud_cambio,:grupo_r,:grupo_r_no,:intranet_documento,:intranet_name,:intranet_usuario,:intranet_id,:intranet_cargo,:intranet_proyecto,NOW(),:estado,:tapa_b,:jornada)');
