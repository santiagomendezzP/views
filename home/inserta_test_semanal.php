...
<img id="fondo" src="../../imagenes_videos/imagenes/INICIO/COVID-SEMANAL.png" alt="background image" />
 ...
 <?php 
  ...
  if(isset($_POST['guardar'])){
    ...
    $olfato = isset($_POST['olfato'])?$_POST['olfato']:'';
    ...
    $insert_encuesta_semanal = "INSERT INTO `escuesta_semanal` (`id_usuario`, `id_cargo`, `id_proyecto`, `id_perfil`, `usuario`, `fecha`,`tos`, `fiebre`, `d_respirar`, `fatiga`, `malestar`, `secreciones`, `dolor_g`, `olfato`, `tapa_bocas`,`firstime`, `id_estad`, `primera_dosis`, `segunda_dosis`, `primer_refuerzo`, `segundo_refuerzo`) VALUES ('$intranet_id', '$intranet_cargo', '$intranet_proyecto', '$intranet_perfil', '$intranet_usuario', current_timestamp(),'$tos', '$fiebre', '$d_respirar', '$fatiga', '$malestar', '$secreciones', '$dolor_g', '$olfato', '$tapa_b', '0', '1', '$nombre_vacuna_1', '$nombre_vacuna_2', '$nombre_vacuna_3', '$nombre_vacuna_4');";
    mysqli_query($con,$insert_encuesta_semanal);
