...
<head>
    ...
    <style>
        ...
        .formulario_encuesta {
            ...
            padding: 5rem;
            box-shadow: 0px 1px 10px 0 rgb(0 0 0 / 8%);
            width: 88%;
            margin: 0px auto;
        }
...
<body class="animsition">
    ...
    <div class="page">
        <div class="contenedor">
            <div class="formulario_encuesta">
                <h3>
                    <center><p>Reporte de síntomas de salud relacionadas con Covid 19:</p><p>Interesados en su bienestar, hemos adoptado todas las medidas posibles para evitar el riesgo de contagio por Covid 19. En caso de que presente síntomas lo invitamos a responder lo siguiente:</p></center>
                </h3>
                <form action="inserta_test_diario.php" method="post">
                    <div class="div_label">
                        <label class="required">En las últimas 24 horas, ¿ha presentado síntomas asociados a la infección por Covid 19 tales como:</label>
                    </div>
                    <table>
                        <tr>
                            <td>
                                <label>Tos seca y persistente?</label>
                            </td>
                        ...
                        <tr>
                            <td>
                                <label> Fiebre de más de 37.5°C ?</label>
                            </td>
                            <td style="background-color:white">
                        ...
                        <tr>
                            <td>
                                <label> Dificultad para respirar de inicio reciente?</label>
                            </td>
                            <td style="background-color:white">
                        ...
                        <tr>
                            <td>
                                <label> Malestar general o escalofríos que limiten las actividades de la vida diaria?</label>
                            </td>
                            <td style="background-color:white">
                        ...
                        <tr>
                            <td>
                                <label>Secreción nasal o congestión, no relacionada con procesos alérgicos?</label>
                            </td>
                            <td style="background-color:white">
                        ...
                        <tr>
                            <td>
                                <label> Pérdida del olfato o del gusto?</label>
                            </td>
                            <td style="background-color:white">
                    ...
                    <div class="div_label">
                        <label class="required">¿Se encuentra en las instalaciones de la empresa?</label>
                    </div>
                    <div class="form-group" style="color: black;">
                        SI <input type="radio" name="instalaciones" value="Se encuentra en las instalaciones"  required>
                        NO <input type="radio" name="instalaciones" value="No se encuentra en las instalaciones" required checked>
                    </div>
                    <div class="enviar">
