    ...
    <?php } else {?> 
      ...
      <body>
       ...
       <table class="alguien" style="border: hidden">
        <tr>
          <td style="border: hidden">
           <p><font size ="3", color="black"><b>En el transcurso de la semana pasada, ¿a alguna persona con la que usted conviveo con quien haya  tenido   </p></b></font>
...
<div class="respuesta1" style="display: none;">
  <table class="grupo" style="border: hidden">
    <tr>
      <td style="border: hidden">
        <font size ="3", color="black"><b>¿Cuántas dosis ha recibido?
        </b></font>
      </td>
      <td>
       <div class="form-group">
...
<div class="respuesta2" style="display: none">
  <table class="grupo" style="border: hidden">
    <tr>
      ...
      <td>
       <div class="form-group">
         SI<input type="radio" name="dispuesto_aplicarse" value="SI">
         NO<input type="radio" name="dispuesto_aplicarse" value="NO"> 
       </div> 
     </td>  
   </tr>
 </table>
