    ...
    <?php } else {?> 
      ...
      <body>
           ...
           <table  style="border: hidden"  class="conoce">
            <tr>
              <td style="border: hidden">
               <p><font size ="3", color="black"><b>¿Cconoce usted las medidas dispuestas por la Empresa para atender la emergencia del Covid 19? </p></b></font>  
             </td>
             <td>
       ...
       <table class="alguien" style="border: hidden">
        <tr>
          <td style="border: hidden">
           <p><font size ="3", color="black"><b>En el transcurso de la semana pasada, ¿a alguna persona con la que usted convive o con quien haya  tenido   </p></b></font>
           <p><font size ="3", color="black">contacto se le ordenó cuarentena preventiva o se le diagnosticó infección por Covid 19?</p>
         </td>
         <td>
           <div class="form-group">
           SI <input type="radio" name="alguien" value="SI"required>
            NO<input type="radio" name="alguien" value="NO" required> 
          </div> 
        </td>
      </tr>
    </table>
...
<table class="grupo" style="border: hidden">
  <tr>
   ...
   <td>
     <div class="form-group">
       SI<input type="radio" name="grupo_r" id="grupo_r" value="SI"required>
       NO<input type="radio" name="grupo_r" id="grupo_r" value="NO" required> 
     </div> 
   </td>
 </tr>
</table>
...
<table class="24" >
    <tr>
      <td><p><font size ="3", color="black"><b> Mayor de 60 años? </p></b></font>
      </td>
      <td style="background-color:white">
        <div class="form-group">
         SI<input type="radio" name="mayor_60" value="SI" >
         NO<input type="radio" name="mayor_60" value="NO" > 
         <br> 
       </div>
     </td>
   </tr>
   <tr>
    <td><p><font size ="3", color="black"><b>Tensión alta ?</p></b></font></td>
    <td style="background-color:white">
      <div class="form-group">
       SI<input type="radio" name="tension_alta" value="SI">
       NO<input type="radio" name="tension_alta" value="NO" > 
       <br> 
     </div>
   </td>
 </tr>
 <tr>
  <td> <p><font size ="3", color="black"><b>Embarazo? </b></font></td>
    <td style="background-color:white"><div class="form-group">
      SI<input type="radio" name="embarazo" value="SI">
      NO<input type="radio" name="embarazo" value="NO" > 
      <br> 
    </div>
  </td>
</tr>
<tr>
  <td> <font size ="3", color="black"><b><p>Enfermedad pulmonar (EPOC, Cáncer de pulmón, fibrosis quística, fibrosis pulmonar, asma moderada a grave)?</p></b></font></td>
  <td style="background-color:white">
    <div class="form-group">
      SI<input type="radio" name="enfermedad_pulmonar" value="SI">
      NO<input type="radio" name="enfermedad_pulmonar" value="NO" > 
      <br> 
    </div>
  </td>
</tr>
<tr>
  <td ><font size ="3", color="black"><b> <p>Afecciones cardíacas graves (Miocardiopatía, hipertensión pulmonar, enfermedad cardíaca congénita, insuficiencia cardíaca, enfermedad de las arterias coronarias)?</p></b></font></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="afecciones_cardiacas" value="SI">
    NO <input type="radio" name="afecciones_cardiacas" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<tr>
  <td><p><font size ="3", color="black"><b>Deficiencias del sistema inmune y/o enfermedades diagnosticadas que lo afectan ( Inmunodeficiencia primaria, VIH, trasplantes de órganos o de médula, estar recibiendo tratamiento oncológico)  </p></b></font></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI<input type="radio" name="sistema_inmunitario" value="SI">
    NO<input type="radio" name="sistema_inmunitario" value="NO" > 
    <br> 
  </div>
</td>
</tr>
<tr>
  <td > <p><font size ="3", color="black"><b>Cancer?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="cancer" value="SI">
    NO <input type="radio" name="cancer" value="NO" > 
    <br> 
  </div>
</td>
</tr>
<tr>
  <td > <p><font size ="3", color="black"><b>Tabaquismo?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="tabaquismo" value="SI">
    NO <input type="radio" name="tabaquismo" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<tr>
  <td > <p><font size ="3", color="black"><b>Obesidad?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="obesidad" value="SI">
    NO <input type="radio" name="obesidad" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<tr>
  <td > <p><font size ="3", color="black"><b>Diabetes?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="diabetis" value="SI">
    NO <input type="radio" name="diabetis" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<tr>
  <td > <p><font size ="3", color="black"><b>Enfermedad renal y hepática crónica o en tratamiento de diálisis ?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="enfermedad_renal" value="SI">
    NO <input type="radio" name="enfermedad_renal" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<tr>
  <td > <p><font size ="3", color="black"><b>Otro ?  </b></font></p></td>
  <td style="background-color:white">           
   <div class="form-group">
    SI  <input type="radio" name="otro" value="SI">
    NO <input type="radio" name="otro" value="NO" > 
    <br> 
  </div>
</td>
</tr>
...
<div id="repuesta_otro">
  <tr>
    <td > <p><font size ="3", color="black"><b>Cual?  </b></font></p></td>
    <td style="background-color:white">           
    <div class="form-group">
    <input type="text" name="cual" id="cual"  value="NO"  class="form-control">
      <br> 
    </div>
  </td>
  </tr>
...
<table class="grupo" style="border: hidden">
  <tr>
    <td style="border: hidden">
      <font size ="3", color="black"><b>¿Le aplicaron a usted la vacuna contra el Covid 19?</b></font>
    </td>
    <td>
     <div class="form-group">
...
<div class="respuesta1" style="display: none;">
 ...
 <!-- <table class="grupo" style="border: hidden">
    <tr>
      <td style="border: hidden">
        <font size ="3", color="black"><b>Indique el nombre de la vacuna que le fue aplicada:
        </b></font>
      </td>
      <td>
       <div class="form-group">
...
<div class="respuesta2" style="display: none">
  <table class="grupo" style="border: hidden">
    <tr>
      <td style="border: hidden">
        <font size ="3", color="black"><b>¿está dispuesto(a) a aplicarse la mencionada vacuna?
        </b></font>
      </td>
      <td>
       <div class="form-group">
         SI<input type="radio" name="dispuesto_aplicarse" id="dispuesto_aplicarse_si" value="SI">
         NO<input type="radio" name="dispuesto_aplicarse" id="dispuesto_aplicarse_no" value="NO"> 
       </div> 
     </td>  
   </tr>
 </table>
...
<div class="respuesta4" style="display: none">
  <font size ="3", color="black"><b>En caso de que su respuesta sea negativa, ¿explique por qué?</font>
...
$("#nombre_vacuna_1").change(function() {
  ...
  $('[name="aplicaron_vacuna"]').click(function () {
    ...
    if (aplicaron_vacuna == 'SI') {
      ...
      $('[name="dispuesto_aplicarse"]').prop("required",true)
      $('#dispuesto_aplicarse_si').val("SI") 
      $('#dispuesto_aplicarse_no').val("NO") 
    }
  })
