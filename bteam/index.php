...
<html class="no-js css-menubar" lang="es"><!-- InstanceBegin template="/Templates/new_tem_intranet.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <style>
      ...
      .cambioColor {color:#3e8ef7;}
      /* Definimos el color al pasar el mouse por encima */
      .cambioColor:hover {color:black;}
    </style>
  </head>
  <?php
    session_start();
  ...
  <body class="animsition">
    ...
    <script>
      ...
      $("#site_best_team").addClass("active");
      var im = true;
    </script>
    <div class="page">
        ...
        <div class="page-aside-inner page-aside-scroll">
          <div data-role="container">
            <div data-role="content">
              <br>
              <?php
                if($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'andrea.camacho' || $_SESSION['intranet_usuario'] == 'julian.avila'  || $_SESSION['intranet_usuario'] == 'CLAUDIA.BONILLA') {
                  ?>
                  <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#crearSeccionBteam" data-crear_seccion='crear' title="click para crear">
                  ...
                  <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#EliminarSeccionBteam" data-eliminars='Eliminar' title="click para Eliminar sección">
                ...
                $sql_bteam_secciones = mysqli_query($mysqli, "SELECT `id_seccion`, `seccion` FROM `bteam_secciones` WHERE `estado_seccion` = '0' ORDER BY `id_seccion` DESC ");
                while($rowSecciones =  mysqli_fetch_array($sql_bteam_secciones, MYSQLI_ASSOC)) {
                  ...
                  <section class="page-aside-section">
                    <h5 class="page-aside-title">
                      ...
                      if($_SESSION['intranet_usuario'] == 'raul.enciso'|| $_SESSION['intranet_usuario'] == 'andrea.camacho' || $_SESSION['intranet_usuario'] == 'julian.avila'  || $_SESSION['intranet_usuario'] == 'CLAUDIA.BONILLA') {
                        ?>
                        <a class="btn" style="background-color: transparent; border-color: #3e8ef7;" data-toggle="modal" data-target="#CrearPublicacionBteam" data-publicacion='<?php echo $id_seccion?>' data-usuario_intra='<?php echo $_SESSION['intranet_usuario']?>' data-id_seccion='<?php echo $row['id']; ?>' title="click para nueva publicación">
                    ...
                    <?php
                    $sql_bteam = mysqli_query($mysqli, "SELECT `id`, `titulo`, `tabla`, `name`, `type`, `estado_publicacion` FROM `bteam` WHERE `id_seccion` = '$id_seccion' AND `estado_publicacion` = '0' ORDER BY `bteam`.`id` DESC  ");
                    while($row = mysqli_fetch_array($sql_bteam, MYSQLI_ASSOC)) { 
                      ?>
                      <div class="list-group">
                        ...
                        if($_SESSION['intranet_usuario'] == 'raul.enciso'|| $_SESSION['intranet_usuario'] == 'andrea.camacho' || $_SESSION['intranet_usuario'] == 'julian.avila'  || $_SESSION['intranet_usuario'] == 'CLAUDIA.BONILLA') {
                          ?>
                          <p class="page-header">
                            <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#editarSeccionBteam" data-id_seccion='<?php echo $row['id']; ?>' title="click para editar">
                              <span class="cambioColor">Editar</span>
                            </a>
                            <a class="btn" style="background-color: transparent; color: #3e8ef7; border-color: #3e8ef7;" data-toggle="modal" data-target="#eliminarSeccionBteam" data-ideliminarseccion='<?php echo $row['id']; ?>' title="click para eliminar">
      ...
      <div class="page-main">
        <div class="tab-content">
          <?php
          $sql_bteam = mysqli_query($mysqli, "SELECT * FROM `bteam` WHERE `estado_publicacion` = '0' ORDER BY `id` DESC");
          while($row = mysqli_fetch_assoc($sql_bteam)){
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                          <?php
                            if($tipo_imagen == 'video'){
                              ...
                              if($nombre_poster == ''){
                                ?>
                                <video src='./../videos_bteam/<?php echo $nombre_imagen?>' style='width: 100%; height=100%;' controls></video>
                                <?php
                              }else{
                                ?>
                                <video src='./../videos_bteam/<?php echo $nombre_imagen?>' style='width: 100%; height=100%;' poster="./../imagenes_bteam/<?php echo $nombre_poster?>" controls ></video>
                                <?php
                              }
                              ?>
                              <?php
                              ...
                              ?>
                                <img src='./../imagenes_bteam/<?php echo $nombre_imagen?>' width="100%" height="100%" alt="">
                              <?php 
                            }elseif($tipo_imagen == 'pdf'){
                              ?>
                                <iframe src='./../pdf_bteam/<?php echo $nombre_imagen?>' width=1000 height=500></iframe>
                              <?php
                            }else{
                            }
                          ?>
    ...
    <!--CREAR PUBLICACIÓN BTEAM-->
    <div class="modal fade" id="CrearPublicacionBteam" tabindex="-1" role="dialog" aria-labelledby="CrearPublicacionBteamTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="CrearPublicacionBteamTitle">CREAR PUBLICACIÓN</h5>
    ...
    <!--ELIMINAR SECCION BTEAM-->
    <div class="modal fade" id="eliminarSeccionBteam" tabindex="-1" role="dialog" aria-labelledby="eliminarSeccionBteamTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarSeccionBteamTitle">ELIMINAR</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <!--EDITAR SECCION BTEAM-->
    <div class="modal fade" id="editarSeccionBteam" tabindex="-1" role="dialog" aria-labelledby="editarSeccionBteamTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editarSeccionBteamTitle">EDITAR</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <!--CREAR SECCION BTEAM-->
    <div class="modal fade" id="crearSeccionBteam" tabindex="-1" role="dialog" aria-labelledby="crearSeccionBteamTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="crearSeccionBteamTitle">CREAR SECCION</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <!-- ELIMINAR SECCION CREADA BTEAM-->
    <div class="modal fade" id="EliminarSeccionBteam" tabindex="-1" role="dialog" aria-labelledby="EliminarSeccionBteamTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="EliminarSeccionBteamTitle">ELIMINAR SECCION CREADA</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <script>
      $('#verregistros').on('show.bs.modal', function(event) {
        ...
        $.post("./../edicion_bteam/Ver_registros.php", { verregis: verregis }, 
        function(data) {
    ...
    <script>
      $('#EliminarSeccionBteam').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id_Eliminar = button.data('eliminars')
        $(".id_Eliminar").val(id_Eliminar); +
        $.post("./../edicion_bteam/Eliminar_seccion_creada.php", {
    ...
    <script>
      $('#eliminarSeccionBteam').on('show.bs.modal', function(event) {
        ...
        $.post("./../edicion_bteam/Eliminar_seccion.php", {
    ...
    <script>
      $('#editarSeccionBteam').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id_seccion = button.data('id_seccion')
        $(".id_seccion_campo").val(id_seccion); +
        $.post("./../edicion_bteam/Editar_seccion.php", {
    ...
    <script>
      $('#crearSeccionBteam').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var seccion = button.data('crear_seccion')
        $(".seccion_campo").val(seccion); +
        $.post("./../edicion_bteam/Crear_seccion.php", {seccion: seccion}, 
        function(data) {
          $(".crear").html(data);
        })
      })
    ...
    <script>
      $('#CrearPublicacionBteam').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var usuario_crea = button.data('usuario_intra')
        var publicacion = button.data('publicacion')
        $(".publicacion_campo").val(publicacion); +
        $.post("./../edicion_bteam/Crear_publicacion.php", {publicacion: publicacion, usuario_crea: usuario_crea}, 
        function(data) {
