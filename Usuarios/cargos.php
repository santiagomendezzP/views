...
?>
  <body class="animsition">
    ...
    <script>
      ...
      $("#site_panel_cargos").addClass("active");
    </script>
    <div class="page">
     <div class="container">
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <h2 style="color:#58aac6" >PANEL CARGOS</h2>
        ...
        <td>
<div class="btn btn-secondary "  href="#agregarGeneralModal" class="edit" data-toggle="modal" style="padding-left: 10px; margin-left: 1px; background-color: white; border: 1px;" >
        <a   


             data-cargo="<?php echo $cargo?>"  
              data-c_costos="<?php echo $ccostos?>"
              data-jefe="<?php echo $nombre_jefe?>"
              data-id_cargo="<?php echo $id_cargo?>"
              data-funciones_c="<?php echo $funciones_c?>"
              data-id_general="<?php echo $general_id; ?>">

              <i class="fas fa-plus-square" style="font-size:20px; color: #4682B4; "data-toggle="tooltip" title="Agregar cargos"></i>
                </a>
</div>
        </td>
    ...
    <!-- Edit Modal HTML -->
<?php include("html/modal_editar_cargos.php");?>
    <?php include("html/modal_agregar_cargos.php");?>
    <?php include("html/modal_eliminar_cargos.php");?>
