...
?>
  <body class="animsition">
    ...
    <script>
      ...
      $("#site_panel_centro_costos").addClass("active");
    </script>
    <div class="page">
     <div class="container">
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <h2 style="color:#58aac6" >PANEL CENTRO DE COSTOS</h2>
...
<div class="btn btn-secondary "  href="#agregarGeneralModal" class="edit" data-toggle="modal" style="padding-left: 10px; margin-left: 1px; background-color: white; border: 1px;" >
        <a   
              ...
              data-proyecto="<?php echo $id_proyecto?>"  
              data-id_proyecto="<?php echo $id_proyecto?>">

              <i class="fas fa-plus-square" style="font-size:20px; color: #4682B4; "data-toggle="tooltip" title="Agregar centro de costos"></i>
    ...
    <?php include("html/modal_editar_ccostos.php");?>
    <?php include("html/modal_eliminar_ccostos.php");?>
    <?php include("html/modal_agregar_ccostos.php");?>

    <!-- Delete Modal HTML -->
    <script src="js/centro_de_costos.js"></script>
