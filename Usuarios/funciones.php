  ...
  <body class="animsition">
    ...
    <script>
      $(document).ready(function(){
        $("#site_panel_funciones").addClass("active");
      });
    </script>
    <div class="page">
      <div class="container">
        <div class="table-wrapper">
          ...
          <td>
            <div class="btn btn-secondary" href="#importar_funciones" class="edit" data-toggle="modal" style="padding-left: 10px; margin-left: 1px; background-color: white; border: 1px;" >
              <i style="font-size:10px; color: #4682B4; " data-toggle="tooltip" title="Importar funciones"> IMPORTAR FUNCIONES</i>
              </a>
            </div>
          </td>
      ...
      <!-- Edit Modal HTML -->
      <?php include("html/modal_editar_funciones.php");?>
      <?php include("html/modal_eliminar_funciones.php");?>
      <?php include("html/modal_agregar_funciones.php");?>
      <?php include("html/modal_importar_funciones.php");?>
      <!-- Delete Modal HTML -->
