...
?>
  <body class="animsition">
    ...
    <?php
      if ($_SESSION['intranet_usuario'] == 'raul.enciso'  || $_SESSION['intranet_usuario'] == 'david.patiño'  || $_SESSION['intranet_usuario'] == 'lina.tovar' || $_SESSION['intranet_usuario'] == 'LADY.FORERO' || $_SESSION['intranet_usuario'] == 'oscar.hurtado' || $_SESSION['intranet_usuario'] == 'JEISSON.RUIZ' || $_SESSION['intranet_usuario'] == 'yury.valencia') {
    ?>
    <script>
