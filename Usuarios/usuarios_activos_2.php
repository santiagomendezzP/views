...
?>
  <body class="animsition">
    ...
    <?php
      if ($_SESSION['intranet_usuario'] == 'raul.enciso' || $_SESSION['intranet_usuario'] == 'julio.fuentes'  || $_SESSION['intranet_usuario'] == 'david.patiño'  || $_SESSION['intranet_usuario'] == 'luz.aguillon' || $_SESSION['intranet_usuario'] == 'LADY.FORERO' || $_SESSION['intranet_usuario'] == 'oscar.hurtado' || $_SESSION['intranet_usuario'] == 'JEISSON.RUIZ' || $_SESSION['intranet_usuario'] == 'yury.valencia'|| $_SESSION['intranet_usuario'] == 'SERGIO.MORALES') {
    ?>
    <script>
      $("#site_panel_usuarios").addClass("active");
    </script>
    <div class="page">
     <div class="container">
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <h2 style="color:#58aac6" >PANEL USUARIOS</h2>
              <h2>ACTIVOS\USUARIOS</h2>
            </div>
        ...
        <div class='col-sm-4 pull-right'>
          <div id="custom-search-input">
            <div class="input-group col-md-12">
              <input type="hidden" class="form-control"  id="q" onkeyup="load(1);" />
        ...
        <td>
          <div class="btn btn-secondary"  href="#agregarGeneralModal" class="edit" data-toggle="modal" style="padding-left: 10px; margin-left: 50px; background-color: white; border: 1px;" >
            <a   
              ...
              <i class="fas fa-user-plus" style="font-size:20px; color: #4682B4; "data-toggle="tooltip" title="Agregar colaborador"></i>
            </a>
          </div>
        </td>
        <div class="btn btn-secondary"  href="#CambiarAprobador" class="edit" data-toggle="modal" style="padding-left: 10px; margin-left: 50px; background-color: white; border: 1px;" >
          <a>
            <i class="fas fa-user-clock" style="font-size:20px; color: #4682B4; "data-toggle="tooltip" title="Cambiar jefe aprobador"></i>
          </a>
        </div>
    ...
    <?php include ("html/modal_editar_usuario.php");?>
    <?php include ("html/modal_agregar.php");?>
    <?php include ("html/modal_clave.php");?>
    <?php include ("html/modal_eliminar.php");?>
    <?php include ("html/modal_cambiar_aprobador.php");?>

    <!-- Delete Modal HTML -->
    <script src="js/adm_2.js"></script>
